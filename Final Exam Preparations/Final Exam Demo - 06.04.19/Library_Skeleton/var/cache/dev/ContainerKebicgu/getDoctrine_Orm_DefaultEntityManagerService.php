...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => 'D:\\Library_Skeleton\\src\\AppBundle\\Entity']), 'AppBundle\\Entity');
...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Repository\\BookRepository' => function () {
    return ${($_ = isset($this->services['AppBundle\Repository\BookRepository']) ? $this->services['AppBundle\Repository\BookRepository'] : $this->load('getBookRepositoryService.php')) && false ?: '_'};
}])));
